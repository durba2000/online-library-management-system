...
<!--_________________sidenav_______________-->
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  			...
  			<div style="color: white; margin-left: 60px; font-size: 20px;">
                ...
                { 	echo "<img class='img-circle profile_img' height=120 width=120 src=".$_SESSION['pic'].">";
                    echo "</br></br>";
...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        ...
        <input type="text" name="tm" class="form-control" placeholder="Return Date APR 26, 2023 15:00:00"  required="">
