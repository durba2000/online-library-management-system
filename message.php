...
<html>
    ...
    <?php
        ...
        ?>
        <div class="wrapper">
            <div style="height: 70px; width: 1000%; background-color: #2eac8b; text-align:center; color:white;"></div>
        ...
        <div class="msg">
            ...
            <br><div class="chat user">
                ...
                &nbsp
                <?php
				 echo "<img class='img profile_img'height=50 width=50 src=".$_SESSION['pic'].">";
               ?>&nbsp
                </div>
            ...
            <br><div class="chat admin">
                <div style="float: left; padding-top: 5px;">
                &nbsp
                <img  style="height: 40px; width: 40px; border-radius: 50%;" src="p.webp">
                &nbsp
                </div>
                <div style="float: left;" class="chatbox">
